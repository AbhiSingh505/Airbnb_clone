        ...
        VStack(alignment: .leading, spacing: 6) {
            ...
            ZStack(alignment: .topLeading) {
                ...
                if let imageURL = imageURL {
                    Group {
                        if let cachedImage = cachedImage {
                            Image(uiImage: cachedImage)
                                ...
                                .blur(radius: isImageRevealed ? 0 : 8)
                                .animation(.easeOut(duration: 0.35), value: isImageRevealed)
                        } else if isLoading {
                            ProgressView()
                    ...
                    .overlay(
                        LinearGradient(colors: [Color.black.opacity(0.05), Color.black.opacity(0.25)], startPoint: .top, endPoint: .bottom)
                            .clipShape(RoundedRectangle(cornerRadius: 16))
                    )
